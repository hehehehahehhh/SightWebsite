...
import { img11, img14, img111 } from "./svg-t633q";
...
function MaskGroup1() {
  return (
    <div className="absolute contents left-0 top-[399px]" data-name="Mask group">
      <div className="absolute h-[349px] left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[437px_349px] top-[399px] w-[466px]" data-name="1（首图） 1" style={{ maskImage: `url('${img11}')` }}>
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[100.14%] left-[-1.46%] max-w-none top-[-0.07%] w-full" src={img12} />
        </div>
      </div>
      <div className="absolute h-[410px] left-[-55px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[55px_30px] mask-size-[437px_349px] top-[369px] w-[547px]" data-name="1（首图） 2" style={{ maskImage: `url('${img11}')` }}>
...
function MaskGroup3() {
  return (
    <div className="absolute contents left-[475px] top-[512px]" data-name="Mask group">
      <div className="absolute h-[472px] left-[467px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[8px_0px] mask-size-[336px_472px] top-[512px] w-[354px]" data-name="1(首图) 1" style={{ maskImage: `url('${img14}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img15} />
      </div>
      <div className="absolute left-[384px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[91px_8px] mask-size-[336px_472px] size-[487px] top-[504px]" data-name="3（首图） 1" style={{ maskImage: `url('${img14}')` }}>
...
function MaskGroup5() {
  return (
    <div className="absolute contents left-[849px] top-[399px]" data-name="Mask group">
      ...
      <div className="absolute left-[849px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_51px] mask-size-[436px_349px] size-[436px] top-[348px]" data-name="5（首图） 1" style={{ maskImage: `url('${img111}')` }}>
