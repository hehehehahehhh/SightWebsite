import svgPaths from "./svg-9s8wmwny9n";
...
import { imgObjects, img41, img22223 } from "./svg-nj6d0";
...
function Group() {
  return (
    <div className="absolute contents left-[1377.61px] top-[76px]">
      <div className="absolute flex items-center justify-center left-[1377.61px] size-[32.864px] top-[76px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-45">
          <div className="bg-black h-[4px] w-[42.477px]" />
        </div>
      </div>
      <div className="absolute flex items-center justify-center left-[1378px] size-[32.864px] top-[76px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
...
function Group1() {
  return (
    <div className="absolute contents left-[1377.61px] top-[76px]">
      <div className="absolute flex items-center justify-center left-[1377.61px] size-[32.864px] top-[76px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-45">
          <div className="bg-white h-[4px] w-[42.477px]" />
        </div>
      </div>
      <div className="absolute flex items-center justify-center left-[1378px] size-[32.864px] top-[76px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="-scale-y-100 flex-none rotate-135">
...
export default function MacBookPro() {
  return (
    <div className="bg-[#f5f5f5] relative size-full" data-name="MacBook Pro 14' - 9">
      ...
      <MaskGroup5 />
      <Group />
      <div className="absolute bg-[rgba(0,0,0,0.9)] h-[1916px] left-0 top-0 w-[1512px]" />
      <div className="absolute h-[1048px] left-[72px] top-[262px] w-[1397px]" data-name="objects">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[100.14%] left-[-1.46%] max-w-none top-[-0.07%] w-full" src={imgObjects1} />
        </div>
      </div>
      <div className="absolute h-[89.618px] left-[1359px] top-[733px] w-[52.298px]" data-name="Union">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 52.2979 89.6182">
          <path d={svgPaths.p11a2b200} fill="var(--fill-0, white)" id="Union" />
        </svg>
      </div>
      <Group1 />
    </div>
