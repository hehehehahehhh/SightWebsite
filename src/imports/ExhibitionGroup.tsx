...
import { img13, imgWeAreBecomingClouds1, img15 } from "./svg-ib3ie";
...
function MaskGroup1() {
  return (
    <div className="absolute contents left-0 top-[389px]" data-name="Mask group">
      <div className="absolute h-[404px] left-[-25px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[25px_18px] mask-size-[437px_349px] top-[371px] w-[538px]" data-name="1(首图) 3" style={{ maskImage: `url('${img13}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img14} />
      </div>
