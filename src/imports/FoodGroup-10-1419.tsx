...
import { imgThreeCats1, imgThreeCats3, imgSumei1 } from "./svg-pqjbg";
...
function Sumei() {
  return (
    <div className="absolute contents left-[849px] top-0" data-name="Sumei 1">
      <div className="absolute h-[349px] left-[843px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[6px_0px] mask-size-[436px_349px] top-0 w-[466px]" data-name="Sumei 1" style={{ maskImage: `url('${imgSumei1}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgSumei2} />
      </div>
    </div>
  );
}
