...
import { imgIvory } from "./svg-cy93s";
...
function Ivory4() {
  return (
    <div className="absolute contents left-0 top-[604px]" data-name="Ivory">
      <div className="absolute h-[565.724px] left-[-10.79px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[10.787px_0px] mask-size-[402.719px_565.725px] top-[604px] w-[424.293px]" data-name="1_首图 1" style={{ maskImage: `url('${imgIvory}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img11} />
      </div>
      <div className="absolute h-[566px] left-[-11px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[11px_0px] mask-size-[402.719px_565.725px] top-[604px] w-[425px]" data-name="4（首图） 1" style={{ maskImage: `url('${imgIvory}')` }}>
