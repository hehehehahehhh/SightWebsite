    ...
    <div className="relative size-full">
      <div className="absolute left-0 size-[98px] top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 98 98">
          <circle cx="49" cy="49" data-figma-bg-blur-radius="18.1" fill="var(--fill-0, #F5F5F5)" fillOpacity="0.4" id="Ellipse 1" r="49" />
          <defs>
            <clipPath id="bgblur_0_26_465_clip_path" transform="translate(18.1 18.1)">
