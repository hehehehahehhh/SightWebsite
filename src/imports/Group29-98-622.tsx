...
import { img61, img41 } from "./svg-tjf07";
...
export default function Group() {
  return (
    <div className="relative size-full">
      ...
      <div className="absolute bg-white h-[592.81px] left-[917px] top-[630px] w-[422px]" />
      <div className="absolute bg-white h-[592.81px] left-0 top-0 w-[422px]" />
      <div className="absolute bg-white h-[592.81px] left-0 top-[630px] w-[422px]" />
