...
import { img13, imgWeAreBecomingClouds1, img15 } from "./svg-1p5rz";
...
function MaskGroup2() {
  return (
    <div className="absolute contents left-0 top-[778px]" data-name="Mask group">
      <div className="absolute h-[348px] left-[-14px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[14px_-1px] mask-size-[437px_349px] top-[779px] w-[465px]" data-name="8.jpg（首图） 1" style={{ maskImage: `url('${img13}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img8Jpg1} />
      </div>
    </div>
  );
}
