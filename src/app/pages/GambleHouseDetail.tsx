...
// Gamble House images from Figma
...
const images = [
  { src: img111, alt: "Gamble House 1" },
  { src: img22226, alt: "Gamble House 2" },
  { src: img333337, alt: "Gamble House 3" },
  { src: img43, alt: "Gamble House 4" },
];

export default function GambleHouseDetail() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[1512px] mx-auto px-4 md:px-16 py-10 md:py-24">
        ...
        <div className="hidden md:block w-full relative" style={{ paddingBottom: '66.94%' }}>
          {/* 1137 / 1339 = 0.8491 or 84.91% aspect ratio */}
          <div className="absolute inset-0">
            {/* Background cells */}
            <div className="absolute bg-[#f5f5f5] h-[52.14%] left-0 top-0 w-[31.52%]" />
            <div className="absolute bg-[#f5f5f5] h-[52.14%] left-[34.13%] top-0 w-[31.52%]" />
            <div className="absolute bg-[#f5f5f5] h-[52.14%] left-[68.49%] top-0 w-[31.52%]" />
            <div className="absolute bg-[#f5f5f5] h-[52.14%] left-0 top-[55.41%] w-[31.52%]" />

            {/* Image 1 - First Gamble House image (top left) */}
            <div 
              className="absolute overflow-hidden group cursor-pointer"
              style={{ left: '0%', top: '7.48%', width: '31.52%', height: '37.12%' }}
            ...
            {/* Image 2 - Second image (middle top) */}
            <div 
              className="absolute overflow-hidden group cursor-pointer"
              style={{ left: '34.13%', top: '12.14%', width: '31.52%', height: '27.79%' }}
            ...
            {/* Image 3 - Third image (top right) */}
            <div 
              className="absolute overflow-hidden group cursor-pointer"
              style={{ left: '68.49%', top: '7.48%', width: '31.52%', height: '37.12%' }}
            ...
            {/* Image 4 - Fourth image (bottom left) */}
            <div 
              className="absolute overflow-hidden group cursor-pointer"
              style={{ left: '0%', top: '62.89%', width: '31.52%', height: '37.12%' }}
